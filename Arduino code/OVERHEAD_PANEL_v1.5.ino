...
// --- VARIABLES SECTION --- //
  ...
  // *PANEL C1-3 VARIABLES*
    ...
    // **SERVOS**
      ...
      SERVO SERVO_FUEL_TEMP(52); // Attached to pin D2
      int pos_servo_fuel_temp = 95; // Servo initial position after cool and dark
      String valueDOLLARB; // Entrance to servo position
      int valueDOLLARBi = -167; // valueDOLLARC string converted to integer (initial before cool and dark)
      int servo_activated = 0; // Initially disconnected
  ...
  // *PANEL C1-4 VARIABLES*
    ...
    // **SERVOS**
      ...
      SERVO SERVO_SELECTOR_ENGINE_STARTOR(47); // Attached to pin D3
      int pos_servo_selector_engine_startor = 180; // Servo initial position after cool and dark
  ...
  // *PANEL C2-2 VARIABLES*
    ...
    // **LEDS**
      ...
      int prevalueDD = '1'; // Temporal solution to 'Zc' issue
  ...
  // *PANEL C2-4 VARIABLES*
    ...
    // **SERVOS**
      ...
      SERVO SERVO_EGT_APU(53); // Attached to pin D4
      int pos_servo_egt_apu = 13; // Posición del servo
 ...
 // *PANEL C5-4 VARIABLES*
    ...
    // **LEDS**
      ...
      int valueGGi = 0, valueGHi = 0; //Control LED numbers on the display, integer value
  ...
  // *COLD AND DARK SETUP*
    ...
    // **PANEL C1-4 COLD AND DARK**   
      ...
      // ***SERVOS***
        ...
        delay(100);
        SERVO_SELECTOR_ENGINE_STARTOR.Update(0, 178);
...
void loop() {
    ...
    // **LED TEST LOGIC**
      ...
      if((LED_TEST) == 0){
        ...
        // ***PANEL C4-2***
          ...
          if(valueEM == '0') {bitClear(SR_OUT_15,0);}
          if(valueEN == '0') {bitClear(SR_OUT_15,1);}
          if(valueEO == '0') {bitClear(SR_OUT_15,2);}
          if(valueEP == '0') {bitClear(SR_OUT_15,3);}
          if(valueEQ == '0') {bitClear(SR_OUT_15,4);}
          if(valueER == '0') {bitClear(SR_OUT_15,5);}
        ...
        // ***PANEL C4-3***
          ...
          if(valueEW == '0') {bitClear(SR_OUT_16,2);}
          if(valueEX == '0') {bitClear(SR_OUT_16,3);}
    ...
    // **LED ENERGY LOGIC**
      ...
      if(aircraft_energy == 2){
        ...
        // ***PANEL C1-3***
          ...
          SERVO_FUEL_TEMP.Update(10, pos_servo_fuel_temp);
        ...
        // ***PANEL C5-3***
          ...
          if(valueFS == '1'){bitSet(SR_OUT_18,5);}     
  ...
  // *SWITCHES*
    ...
    // **PANEL C1-4 SWITCHES**
      ...
      // ***SWITCHES LOGIC***
        ...
        if( ((SWITCH_APU_1) == 0) && ((SWITCH_APU_2) == 1) && (PRE_SWITCH_APU == 1) ){ if( (millis()-lastUpdateSwitch) > 10){Serial.println("Ai0"); PRE_SWITCH_APU = 0; lastUpdateSwitch = millis();} }
  ...
  // *AIRCRAFT ENERGY STATES*
    ...
    else if( PRE_SWITCH_MAIN_BATTERY == 1 && ground_power == 1 ){aircraft_energy=2;}
...
// --- FUNCTION SECTION --- //
  ...
  // *GETCHAR FUNCTION*
    ...
    char getChar() { // Get one character from serial buffer
      while(Serial.available() == 0); //Wait for the data
    ...
    void D(){ // First identifier has been D 
      ...
      switch(CodeIn) {
        ...
        case 'D': // CODE DD; LED DRIVE_2
          ...
          if ( (valueDD == '0') && (prevalueDD == '1') ){
            bitClear(SR_OUT_10,6);
            update_SR_OUT_4();
            delay(10000);
            SERVO_SELECTOR_ENGINE_STARTOR.Update(150, 0);
            delay(500);
            SERVO_SELECTOR_ENGINE_STARTOR.Update(0, 178);
          }
          update_SR_OUT_4();
        ...
        case 'L': // CODE DL; LED APU_GEN_OFF_BUS
          valueDL = getChar();
          if (valueDL == '1'){ bitSet(SR_OUT_11,6); }
    ...
    void E(){ // First identifier has been E 
      ...
      switch(CodeIn) {
        ...
        case 'W': // CODE EW; LED LOW_PRESSURE_ELEC_1
          valueEW = getChar();
          if (valueEW == '1'){ bitSet(SR_OUT_16,2); }
        ...
        case 'X': // CODE EX; LED LOW_PRESSURE_ELEC_2
          valueEX = getChar();
          if (valueEX == '1'){ bitSet(SR_OUT_16,3); }
    ...
    void DOLLAR(){ // First identifier has been $
      ...
      switch(CodeIn) {
        ...
        case 'B': // CODE $B; SERVO_FUEL_TEMP
            ...
            valueDOLLARB = "";
            valueDOLLARB = Serial.readStringUntil('\n');
            valueDOLLARBi = valueDOLLARB.toInt();
            pos_servo_fuel_temp = map(valueDOLLARBi, -167, 167, 1, 180);
        ...
        case 'C': // CODE $C; SERVO_EGT_APU
            ...
            valueDOLLARC = "";
            valueDOLLARC = Serial.readStringUntil('\n');
            valueDOLLARCi = valueDOLLARC.toInt();
            pos_servo_egt_apu = map(valueDOLLARCi, 0, 1000, 13, 155);
          
          if (servo_activated == 1){                
            SERVO_EGT_APU.Attach();
            SERVO_EGT_APU.Update(10, pos_servo_egt_apu);
  ...
  // *REFRESH DISPLAY FUNCTION*
    ...
    void refreshDisplay(){
      ...
      for (display_pos=0; display_pos<3; display_pos++){
        ...
        switch( shift_number_1[display_pos] ){
        ...
        switch( shift_number_5[display_pos] ){ //AC VOLTS DISPLAY
          ...
          if ( (neg_num_1 == 1) && (display_pos == 0) ){ //print a dash (-) on the first digit
          ...
          if ( (neg_num_4 == 1) && (display_pos == 0) ){ //print a dash (-) on the first digit
          ...
          if (PRE_SELECTOR_AC_SOURCE ==2){bitSet(SR_OUT_6,1); bitSet(SR_OUT_6,2); bitSet(SR_OUT_6,3);}          
          if (PRE_SELECTOR_AC_SOURCE ==3){bitSet(SR_OUT_6,1); bitSet(SR_OUT_6,2); bitSet(SR_OUT_6,3);}          
          if (PRE_SELECTOR_AC_SOURCE ==4){bitSet(SR_OUT_6,1); bitSet(SR_OUT_6,2); bitSet(SR_OUT_6,3);}          
          ...
          delay(2); //delay as long as necessary to get time to watch on display
          update_SR_OUT_4();
